self.onInit = function() {
        ...
        return saveEntityGroup({
            ...
            rx.switchMap((entityViewGroup) => {
                return saveEntityGroup({
                    ...
                    rx.switchMap((userGroup) => shareEntityGroupToUserGroup$(
                        entityViewGroup && entityViewGroup.id ? entityViewGroup.id.id : null,
                        userGroup && userGroup.id ? userGroup.id.id : null
                    ).pipe(
                        rx.map(() => ({
                            entityViewGroupId: entityViewGroup && entityViewGroup.id ? entityViewGroup.id.id : null,
                            userGroupId: userGroup && userGroup.id ? userGroup.id.id : null
                        }))
                    ))
                );
            }),
    ...
    function createUserAccount$() {
        return self.ctx.userService.saveUser({
            ...
            customerId: {
                entityType: 'CUSTOMER',
                id: '6c4d7b80-efbd-11f0-99ef-5142a24e3d47'
            },
            additionalInfo: {
                description: "auto-generated by 'btc create customer' widget"
            },
