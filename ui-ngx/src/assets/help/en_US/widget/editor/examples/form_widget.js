self.onInit = function() {
    ...
    function extractSelectedUserId() {
        ...
        if (stateParams) {
            return stateParams.selectedUserId || stateParams.userId || stateParams.entityId || stateParams.selectedEntityId || null;
        }
        if (self.ctx.defaultSubscription && self.ctx.defaultSubscription.targetEntityId && self.ctx.defaultSubscription.targetEntityId.id) {
            return self.ctx.defaultSubscription.targetEntityId.id;
        }
        return null;
    }
